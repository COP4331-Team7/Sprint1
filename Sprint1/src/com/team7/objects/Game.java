...
public class Game {
    ...
    public void startGame() {
        ...
        players[0].addUnit(new Explorer(this.map.getGrid()[0][map.getGrid().length - 1], players[0]));


        players[1].addUnit(new Explorer(this.map.getGrid()[map.getGrid().length - 1][0], players[1]));
